...
private:
    ...
    Eigen::MatrixXd selectMostRestrictiveRestrictions(std::vector<Eigen::MatrixXd>& bodyRestrictionsCandidates);
...
public:
    ...
    Eigen::VectorXd computeJointVelocities(Eigen::VectorXd& q, Eigen::Vector3d& xDot,
                                           ...
                                           ros::Rate& r);
    Eigen::Vector3d computeRepulsiveVector(Eigen::MatrixXd& jointPositions, std::vector<Eigen::Vector3d>& obstaclePositionVectors);
    Eigen::MatrixXd computeBodyRestrictions(Eigen::MatrixXd& jointPositions,
                                            std::vector<Eigen::Vector3d>& obstaclePositionVectors,
